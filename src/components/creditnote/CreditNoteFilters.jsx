...
const CreditNoteFilters = ({
  ...
  const statusOptions = [
    { value: "All", label: "All Credit Notes", count: null },
    { value: "Applied", label: "Applied", count: null },
    { value: "Pending", label: "Pending", count: null },
    { value: "Void", label: "Void", count: null },
  ];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex-1 max-w-lg">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search credit notes by number or customer name..."
              value={searchTerm}
